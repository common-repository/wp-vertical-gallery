...
?>
<?php if(isset($gvrt->messages['upload']) && is_array($gvrt->messages['upload']) && count($gvrt->messages['upload']) > 0): ?>
<div class="updated">
<p class="">
<?php foreach($gvrt->messages['upload'] as $msg): ?>
	<span><?php print $msg; ?></span><br/>
<?php endforeach;?>
</p>
</div>
<?php endif; ?>
<script type="text/javascript">var vrt_current_album_id = <?php print $album['album_id']; ?>;</script>
<div class="dataTable_wrapper">
	<div class="fg-toolbar ui-toolbar ui-widget-header ui-corner-tl ui-corner-tr ui-helper-clearfix">
		...
		<?php vrt_get_table_actions(array('vrt_bulk_delete_images' => 'Delete', 
											'vrt_bulk_disable_images' => 'Disable', 
											'vrt_bulk_enable_images' => 'Enable')); ?>
	</div>
	...
	<tbody>
	<?php require_once VRT_PLUGIN_DIR . '/html/images_rows.php'; ?>
	</tbody>
	</table>
...
<div id="single_upload" class="tab_content">
	<form id="single_upload_form" action="" method="post" enctype="multipart/form-data">
		<input type="hidden" name="task" value="vrt_single_image_upload" />
...
-->
	...
	var vrt_upload_dir = "<?php  /* add the replace "\\" to work on windows server */  print str_replace("\\","/",vrt_get_album_dir($album['album_id'])); ?>";
	var vrt_secw = "<?php 
	global $wpdb;
	$query = "SELECT txt FROM {$wpdb->prefix}vrt_misc WHERE ione=1 AND itwo=1 AND ithree=1 LIMIT 1";
